...
class RequestOutput:
    ...
    Args:
        ...
        encoder_prompt_token_ids: The token IDs of the encoder prompt;
                                  None if decoder-only
        prompt_hidden_states: Model hidden states for the request prompt tokens.
    """
    ...
    def __repr__(self) -> str:
        return (f"RequestOutput(request_id={self.request_id}, "
                ...
                f"Tensor({self.prompt_hidden_states.shape}))" if self.prompt_hidden_states is not None else "None)")
